...
export class CategoryRepository {
    static async findAll() {
        return query('SELECT * FROM "ProjectCategories" WHERE "IsActive" = TRUE ORDER BY "CategoryName" ASC');
    }
    static async findById(categoryId) {
        return queryOne('SELECT * FROM "ProjectCategories" WHERE "CategoryId" = @id', [
