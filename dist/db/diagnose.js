...
async function main() {
    ...
    try {
        ...
        const who = await client.query(`SELECT current_user AS "user", current_database() AS "db", version() AS "version"`);
      ...
      `);
            ...
            console.log(`5. Data: ${c.users} user(s), ${c.roles} role(s), ${c.projects} project(s), ` +
