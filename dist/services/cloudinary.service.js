...
export class CloudinaryService {
     ...
     */
    static async checkCloudinaryHealth() {
     ...
     */
    static async uploadFile(fileData, folder = 'kenha_vr_projects', resourceType = 'auto') {
        try {
     ...
     */
    static generateUploadSignature(folder = 'kenha_vr_projects', tags = ['kenha']) {
        if (!env.CLOUDINARY_CLOUD_NAME || !env.CLOUDINARY_API_KEY || !env.CLOUDINARY_API_SECRET) {
