...
/* =========================================================
   6. PROJECT MEDIA
   Actual files live in Cloudinary/Azure Blob/etc.
   SQL Server stores metadata and URLs.
   ========================================================= */
...
/* =========================================================
   ...
   Useful for roads and expressways on the real map.
   Stores GeoJSON or WKT generated by the mapping layer.
   ========================================================= */
...
/* =========================================================
   ...
   These settings control how a project behaves in the
...
/* =========================================================
   13. VR HOTSPOTS
   Optional future capability for 360/3D experiences.
   ========================================================= */
...
(
    N'KEN-001',
    N'Nairobi Expressway',
    N'nairobi-expressway',
    N'A major expressway connecting Nairobi and Mlolongo.',
    N'The Nairobi Expressway is a major transport infrastructure project designed to improve connectivity, reduce congestion and improve movement of people and goods.',
    N'Completed',
    N'Draft',
    '2017-10-01',
    '2022-05-14',
...
INSERT INTO ProjectCategoryMap (ProjectId, CategoryId)
SELECT @ProjectId, CategoryId
FROM ProjectCategories
WHERE CategoryName = N'Expressways';

INSERT INTO ProjectStatistics
(
    ProjectId,
    MetricName,
    MetricValue,
...
VALUES
(@ProjectId, N'Total Length', N'27.1', N'KM', 1),
(@ProjectId, N'Lanes', N'4', N'Lanes', 2),
(@ProjectId, N'Project Cost', N'80', N'Billion KES', 3),
(@ProjectId, N'Completion Year', N'2022', N'Year', 4);

INSERT INTO VRProjectSettings
(
    ProjectId,
    MarkerColor,
    MarkerSize,
    FlyToAltitude,
    FlyToDurationSeconds,
    PanelPosition,
    AutoPlayFeaturedVideo,
    EnableVR,
...
/* =========================================================
   22. USEFUL PUBLIC API QUERY
   Returns only published projects and their map coordinates.
   ========================================================= */
